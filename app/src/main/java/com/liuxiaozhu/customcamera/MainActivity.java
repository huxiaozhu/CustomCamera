...
//    private Camera.Parameters parameters;
    ...
    private boolean creatFiles() {
        ...
        if (sdCardExist) {
            //获取SD卡根目录的绝对路径+自建包名
            path = Environment.getExternalStorageDirectory().getAbsolutePath() + "/刘小猪";
    ...
    private void startRecord(){
        ...
        /**
         * 设置竖屏情况下录制视频不会旋转
         * 参考：http://blog.csdn.net/u014665060/article/details/53037864
         * 如果横屏各减90
         */
        if (cameraPosition == 0) {
//            前置摄像头
        ...
        //设置录制视频的大小，这里设置为当前手机屏幕一样的大小
        //必须在setVideoSource()和setOutputFormat之后调用
